...
export default function Modelo123Page() {
  const router = useRouter();
  const { isAllowed, loading: accessLoading, refresh: refreshAccess } = useModelAccess('123');
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-8 text-center">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Modelo 123 no habilitado</h2>
          ...
          <>
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 mb-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Modelo 123</h1>
                  <p className="text-gray-600">Retenciones sobre rendimientos de capital mobiliario</p>
                </div>
              </div>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h3 className="font-semibold text-blue-900 mb-2">Que es el Modelo 123?</h3>
                <p className="text-sm text-blue-800 mb-2">
                  El Modelo 123 declara las retenciones sobre rendimientos de capital mobiliario como:
                </p>
                <ul className="text-sm text-blue-800 space-y-1 ml-4 list-disc">
                  <li>Intereses de prestamos</li>
                  <li>Dividendos de acciones propias</li>
                  <li>Rendimientos de cuentas en entidades aseguradoras</li>
                </ul>
                <p className="text-sm text-blue-800 mt-2">
                  <strong>Nota:</strong> La mayoria de autonomos no necesitan este modelo.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-8 text-center">
              ...
              <p className="text-gray-600 mb-4">
                Este modelo se usa en situaciones especificas con rendimientos de capital mobiliario.
              </p>
            </div>

            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 mt-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Informacion del Modelo 123</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <h4 className="font-semibold text-gray-800 mb-2">Tipo de retencion</h4>
                  <p className="text-sm text-gray-600">General: 19% sobre rendimientos de capital mobiliario.</p>
                </div>
              </div>
              <a href="https://sede.agenciatributaria.gob.es/Sede/procedimientoini/G107.shtml" target="_blank" rel="noopener noreferrer"
                className="text-blue-600 hover:underline font-medium text-sm flex items-center gap-1">
                Acceder al Modelo 123 en la AEAT
