...
export default function Modelo190Page() {
  ...
  const { isAllowed, loading: accessLoading, refresh: refreshAccess } = useModelAccess('190');
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-8 text-center">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Modelo 190 no habilitado</h2>
          ...
          <>
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 mb-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Modelo 190</h1>
                  <p className="text-gray-600">Resumen anual de retenciones e ingresos a cuenta del IRPF</p>
                </div>
              </div>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h3 className="font-semibold text-blue-900 mb-2">Que es el Modelo 190?</h3>
                <p className="text-sm text-blue-800">
                  El Modelo 190 es la declaracion informativa anual que resume todas las retenciones
                  practicadas durante el ano a trabajadores y profesionales (declaradas en los Modelo 111 trimestrales).
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-8 text-center">
              ...
              <p className="text-gray-600 mb-4">
                El resumen anual se generara automaticamente a partir de los Modelo 111 trimestrales.
              </p>
            </div>

            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 mt-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Informacion del Modelo 190</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <h4 className="font-semibold text-gray-800 mb-2">Plazo de presentacion</h4>
                  <p className="text-sm text-gray-600">Del 1 al 31 de enero del ano siguiente al ejercicio.</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <h4 className="font-semibold text-gray-800 mb-2">Relacion con Modelo 111</h4>
                  <p className="text-sm text-gray-600">La suma de los 4 trimestres del 111 debe coincidir con el 190.</p>
                </div>
              </div>
              <a href="https://sede.agenciatributaria.gob.es/Sede/procedimientoini/G301.shtml" target="_blank" rel="noopener noreferrer"
                className="text-blue-600 hover:underline font-medium text-sm flex items-center gap-1">
                Acceder al Modelo 190 en la AEAT
